...
contract Helper {
    ...
    uint64 constant chainIdBinanceTest = 13264668187771770619;
    ...
    address constant routerBinanceTest =
    ...
    address constant linkBinanceTest =
    ...
    address constant wbnbBinanceTEst =
    ...
    address constant ccipBnMBinanceTest =
        0xf1E3A5842EeEF51F2967b3F05D45DD4f4205FF40;
    ...
    address constant clCcipLnMBinanceTest =
        0xc1c76a8c5bFDE1Be034bbcD930c668726E7C1987;
    ...
    constructor() {
        ...
        networks[SupportedNetworks.BINANCE_TEST] = "Binance Test";
    }
    ...
    function getDummyTokensFromNetwork(
        ...
        } else if (network == SupportedNetworks.BINANCE_TEST) {
            return (ccipBnMBinanceTest, clCcipLnMBinanceTest);
        }
    }
